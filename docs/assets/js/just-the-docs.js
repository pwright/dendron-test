(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://pwright.github.io/dendron-test/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://pwright.github.io/dendron-test/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://pwright.github.io/dendron-test/assets/css/just-the-docs-' + theme + ".css"
      );
    };
